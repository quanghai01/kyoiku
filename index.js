...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[212,962,107,107],[1282,882,99,61],[0,1023,107,107],[109,1023,99,61],[321,962,107,107],[1302,945,99,61],[430,962,107,107],[539,962,107,107],[648,962,107,107],[757,962,107,107],[866,962,107,107],[975,962,107,107],[1383,882,41,53],[1084,962,107,107],[1193,962,107,107],[1282,119,107,107],[1282,228,107,107],[1282,337,107,107],[1282,446,107,107],[1282,555,107,107],[1282,664,107,107],[1282,773,107,107],[1391,119,41,53],[0,0,1280,960],[1282,0,117,117],[0,962,210,59]]}
];
...
(lib.mc_btn1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-105,-29.5);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.card1},{t:this.card2},{t:this.card3},{t:this.card4},{t:this.card5},{t:this.card6},{t:this.card7},{t:this.card8},{t:this.card9}]}).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.g1},{t:this.g2},{t:this.g3},{t:this.g4},{t:this.g5},{t:this.g6},{t:this.g7},{t:this.g8},{t:this.g9}]}).wait(1));

	// box
	this.box3 = new lib.mc_box2();
	this.box3.setTransform(651.1,576.55);

	this.box2 = new lib.mc_box2();
	this.box2.setTransform(651.1,417.1);

	this.box1 = new lib.mc_box2();
	this.box1.setTransform(489,417.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.box1},{t:this.box2},{t:this.box3}]}).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.back_mc},{t:this.next_mc},{t:this.page1_mc},{t:this.page2_mc},{t:this.page3_mc}]}).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1577584826102", id:"index_atlas_"}
	],
	preloads: []
};
